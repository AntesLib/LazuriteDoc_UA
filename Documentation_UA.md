...
# Вивід в консоль 
Саме просте що можна написати - це Hello World. Звичайно саме з цієї програми починається шлях будь-якого программіста. У Lazurite вивести текст можна 2 методами - print() і println()
